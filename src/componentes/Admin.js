                ...
                categoria.map(
                    item =>
                        <tr key={item._id}>
                            ...
                            <td>{item.nombre}</td>
                            <td>
                                <Link className="bg-indigo-600 px-0 py-2 text-white uppercase font-bold text-sm rounded-lg" 
                                  to={`/home-productos/${item._id}`}
                                >crear producto</Link>&nbsp;&nbsp;
                                <Link className="bg-red-600 px-0 py-2 text-white uppercase font-bold text-sm rounded-lg"
                                 to={`/actualizar-categoria/${item._id}`}

                                >Editar</Link>&nbsp;&nbsp;
                                <button className="bg-sky-500 px-0 py-2 text-white uppercase font-bold text-sm rounded-lg" 
